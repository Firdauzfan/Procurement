			...
			<div class="row" id="m_user_profile_tab_1">
					<div class="col-md-6">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<select onchange="inquiryCustomer(this.value)" name="inquiry_customer" class="form-control inquiry-customer">
					...
					<div class="col-md-6">
						<div class="form-group m-form__group row">
							...
							<div class="col-md-7">
								<input type="number" name="rfq_number" class="form-control">
							</div>
						</div>
