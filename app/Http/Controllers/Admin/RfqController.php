...
class RfqController extends Controller
{
    ...
    public function saveItemDataUpdate(Request $request)
    {
    	...
    	//
    	return redirect( route('view_rfq',$id) )->with('success', 'Add Item Success');
    }
    ...
    public function getData(Request $request)
    {
        ...
        return Datatables::of($records)
                ->editColumn('rfq_number', function($record) {
                    ...
                    return '<a href="'.route('view_rfq', $record->id).'"">
                        '.$rfqnmb->rfq_number.'
                        </a>';
                })
    ...
    public function update(Request $request)
    {
        ...
        //
        return redirect( route('view_rfq',$id) )->with('success', 'RFQ updated!');
    }
